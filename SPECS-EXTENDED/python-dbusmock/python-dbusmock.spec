...
Source0:          https://files.pythonhosted.org/packages/source/p/%{name}/python_%{modname}-%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
%changelog
* Wed Apr 30 2025 Akhila Guruju <v-guakhila@microsoft.com> - 0.34.3-2
